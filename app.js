...
const sumOneLine = (a, b, c, d) => a+b+c+d ;
...
const objectLitArrowFunc = array =>({key1:'value1',key2:'value2',key3:'value3'})

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(objectLit());
console.log(objectLitArrowFunc())
...
const sumAndProductArrowFunc = (a,b) =>{return[a+b,a*b]};

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(sumAndProduct(3, 9));
console.log(sumAndProductArrowFunc(3, 9));
...
const messageArrowFunc = name =>{return'Hello, '+name+'!'}
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Allie'));
console.log(messageArrowFunc('Allie'));



//------------I am not really sure what is required here.....------------\\
